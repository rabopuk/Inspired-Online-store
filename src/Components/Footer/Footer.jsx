          ...
          <div className={style.development}>
            <ul className={style.developmentList}>
              <li className={style.developmentItem}>
                Designer: <a className={style.link} href="https://t.me/Mrshmallowww" target="blank">Anastasia Ilina</a>
              </li>
              <li className={style.developmentItem}>
                Developer: <a className={style.link} href="https://t.me/rabopuk" target="blank">&#64;rabopuk</a>
              </li>
            </ul>
          </div>
        </div>
